...
@WebServlet("/khoaMoTaiKhoan")
public class KhoaMoTaiKhoanController extends HttpServlet{
	...
	public KhoaMoTaiKhoanController() {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    	...
    	req.setAttribute("nguoiDung", nguoiDungService.layNguoiDungTheoUsername(u));
    	nguoiDungService.khoaMoTaiKhoan(un);
